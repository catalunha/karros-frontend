...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(status: $status, message: $message, tokens: $tokens, profile: $profile)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, message, tokens, profile);
...
abstract class _AuthState implements AuthState {
  factory _AuthState(
      ...
      final String? message,
      final AuthTokens? tokens,
      final UserProfile? profile}) = _$AuthStateImpl;
